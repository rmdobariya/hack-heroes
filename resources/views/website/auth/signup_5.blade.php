                    ...
                    <form id="signup6" method="post">
                        ...
                        <div class="text-center">
                            <p>{{$children}} is
                                ...
                                <select name="geographic_location[{{$key}}]" class="custom-select" required>
                                ...
                                <select name="support_system[{{$key}}]" class="custom-select" required>
                                    <option value="a strong support system, including family members, friends, and other adults who provide emotional support" selected>strong</option>
