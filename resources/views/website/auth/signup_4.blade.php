                    ...
                    <form id="signup5" method="post">
                        ...
                        <div class="sec-add-child">
                            <div class="input-box attribute-row attribute-row-{{$key}}">
                                <div class="form-check">
                                    ...
                                    <input type="hidden" name="gender[{{$key}}]" class="child-sex" value="{{$gender[$key]}}">
                                    <input class="form-check-input" type="checkbox" name="create_plan[{{$key}}]" id="create_plan_{{$key}}" value="on" checked>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label mb-4" for="flexCheckDefault">
                                I have read the <a href="{{$privacy_policy}}" target="_blank">Privacy</a> & <a href="{{$terms_condition}}" target="_blank">Terms</a> and
