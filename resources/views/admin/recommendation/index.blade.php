    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                @include('admin.layouts2.components.bread-crumbs',['main_name'=>'Recommendation'])
                @include('admin.layouts2.components.create-button',['url'=>route('admin.recommendation.create')])
            </div>
        </div>
...
@section('custom-script')
    <script>
        const sweetalert_delete_title = "Recommendation Delete?"
        const sweetalert_delete_text = "Are You Sure Delete This Recommendation"
        const cancel_button_text = "Cancel"
        const delete_button_text = "Delete"
        const sweetalert_change_status = "Recommendation Status Change"
        const sweetalert_change_status_text = "Are You Sure Status Change This Record"
        const yes_change_it = "Yes"
        const form_url = '/recommendation'
        const datatable_url = '/get-recommendation-list'
        var arr = [];
        const multiple_select_title = "Selected Recommendation Delete ?"
        const multiple_select_text = "Are You Sure Selected Record Delete"
        const multiple_delete_url = '/multiple-recommendation-delete'
