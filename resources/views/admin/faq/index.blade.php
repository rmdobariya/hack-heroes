    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                @include('admin.layouts2.components.bread-crumbs',['main_name'=>'Faqs'])
                @include('admin.layouts2.components.create-button',['url'=>route('admin.faq.create')])
            </div>
        </div>
...
@section('custom-script')
    <script>
        const sweetalert_delete_title = "Faq Delete?"
        const sweetalert_delete_text = "Are You Sure Delete This Faq"
        const sweetalert_restore_title = "Faq Restore?"
        const sweetalert_restore_text = "Are You Sure Restore This Faq"
        const cancel_button_text = "Cancel"
        const delete_button_text = "Delete"
        const sweetalert_change_status = "Faq Status Change"
        ...
        const multiple_delete_url = '/multiple-faq-delete'
